...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        // =========================================================================
        // CHANGE THIS VALUE TO MATCH THE COMMAND:
        // "accept", "battle", "catch", "pokedex", "spawn", "leaderboard", or "stats"
        string command = "battle"; 
        // =========================================================================

        // FIXED: Prioritize userDisplayName & userDisplay to get the original message sender
        ...
        CPH.LogInfo($"[GameEngine] command={command} userName={userName} userArg={userArg} arg2={arg2}");
