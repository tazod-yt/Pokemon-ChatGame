...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        string userArg = GetArgValue(new[] { "input0", "arg1", "receiver", "opponent", "target" });
        ...
        {
            CPH.SendYouTubeMessage("Usage: !trade @opponent <pid>");
            return true;
        }

        string processArgs = $"trade {userName} {userArg} {arg2}";

        CPH.LogInfo($"[GameEngine] command={command} sender={userName} receiver={userArg} pid={arg2}");
