...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        string userArg = GetArgValue(new[] { "input0", "arg1", "sender", "challenger", "target" });
        ...
        {
            CPH.SendYouTubeMessage("Usage: !accepttrade @sender <pid>");
            return true;
        }

        string processArgs = $"accepttrade {userName} {userArg} {arg2}";

        CPH.LogInfo($"[GameEngine] command={command} receiver={userName} sender={userArg} pid={arg2}");
