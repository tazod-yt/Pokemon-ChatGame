...
def csharp_bytecode(args: str) -> str:
    lines = [
        ...
        "                        string broadcaster = CPH.GetBroadcasterInfo()?.UserName ?? \"streamer\";",
        "                        CPH.SendMessage(\"⚠️ @\" + broadcaster + \" A new update for Pokemon Chat Game is available (\" + newVer + \")! Download it here: https://github.com/tazod-yt/Pokemon-ChatGame/releases\");",
        "                    }",
